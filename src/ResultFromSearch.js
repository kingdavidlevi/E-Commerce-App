...
<div className= "grid w-full   sm:grid-cols-3 lg:grid-cols-4 grid-cols-2   place-items-center" >
 ...
 { files.map((item,index) => (
  ...
  <div className="  h-100 pt-4 grid place-items-center " style={{'right' : '30%'}}>
    <div className="bg-gray-100  w-40 h-40  rounded-full grid place-items-center "><img src={scope} /> </div>
    <h4 className="font-medium text-center  items-center text-black">There are no results for "<span>{input}</span>"</h4>
