  ...
  return(
    ...
    <div>
     ...
     <div className="absolute left-6 lg:left-12 md:hidden block" onClick={navigateBack}><FaArrowLeft className="text-xl"/></div>
      <div> <input type="text" ref={inputRef} placeholder="Search products, brands and categories" className="w-60 sm:w-96 md:pl-12 ml-12 md:ml-0 text-base pr-4 md:border-r md:border  md:pr-0  placeholder:text-base  border-r-2 outline-none lg:pt-2 lg:pb-2 lg:w-150 xl:w-260 md:w-98 md:pt-1 md:pb-1   border-gray-300" /> </div> 
      <div>  <img src={search} className="absolute right-4 xl:left-80 top-0.5 md:bottom-2 md:left-40 lg:left-64 " /></div>
