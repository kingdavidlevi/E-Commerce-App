...
return(
 ...
 <div className=  "flex justify-between px-8 w-full z-10 fixed top-0   lg:hidden h-14 place-items-center bg-gray-300 "  >
...
<div className=" mt-4 grid place-items-center ">
    ...
    <button className="md:w-53 bg-gray-300 h-12 text-lg font-medium hover:bg-slate-200 rounded-md" type="button" >Cancel</button>
    <button className="text-white text-lg font-normal md:w-53 h-12 rounded-md bg-red-600 hover:bg-red-500" type="button" >Save Changes</button>
    </div>
</div>
...
<div className= "shadow-2xl lg:hidden block mt-30 bg-white  md:w-260 md:h-260 sm:w-100 w-86 pb-4 pt-4  md:pt-10" >
...
<div className="xl:w-82 md:w-70 lg:w-75 md:h-20 mt-6">
 <label  className="font-medium">First Name</label> <br/>
 <input type="text" className=" text-gray-400  bg-gray-100 md:h-10 sm:w-96 rounded-md w-70 pl-4 outline-none mt-1 md:w-70 lg:w-75 xl:w-82" />
</div>


<div className="xl:w-82 lg:w-75 md:h-20 mt-6">
 <label  className= "font-medium">Last Name</label> <br/>
 <input type="text" className=" md:w-70 text-gray-400 w-70 sm:w-96 bg-gray-100 rounded-md md:h-10 outline-none pl-4 lg:w-75 mt-1 xl:w-82" />
</div>
...
<div className="xl:w-82 lg:w-75 md:h-20 mt-8">
 <label  className="font-medium">Email</label> <br/>
 <input type="email" className=" md:w-70 lg:w-75 w-70 sm:w-96 text-gray-400  bg-gray-100 md:h-10 rounded-md pl-4 outline-none mt-1 xl:w-82" />
</div>


<div className="xl:w-82 lg:w-75 md:h-20 mt-8">
 <label   className="font-medium">Address</label> <br/>
 <input type="text" className="text-gray-400 w-70 sm:w-96 lg:w-75 md:w-70 bg-gray-100 rounded-md md:h-10 outline-none pl-4 mt-1 xl:w-82" />
</div>
...
<input className="xl:w-255 md:w-200 lg:w-256 w-70 sm:w-96 rounded-md h-10  text-gray-400 outline-none  bg-gray-100 pl-4" type="password" placeholder="Current Password"/> <br/>
<input className="xl:w-255 md:w-200 lg:w-256 w-70 sm:w-96 rounded-md h-10 text-gray-400 outline-none bg-gray-100 pl-4" type="password" placeholder="New Pasword"/> <br/>
<input className="xl:w-255 md:w-200 lg:w-256 w-70 sm:w-96 rounded-md h-10 text-gray-400 outline-none bg-gray-100 pl-4" type="password" placeholder="Confirm New Password"/> <br/>
